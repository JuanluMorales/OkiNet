...
Collision::CollisionResponse Collision::checkBoundingBox_Sides(CollisionBox* s1, CollisionBox* s2, Animation* anim1, Animation* anim2)
{
	sf::FloatRect s1FR = s1->GetCollisionBox();
	sf::FloatRect s2FR = s2->GetCollisionBox();
	...
	newResponse.s1anim = anim1;
	newResponse.s2anim = anim2;
